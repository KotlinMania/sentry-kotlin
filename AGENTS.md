...
This file is the quick-reference operating contract for sentry-kotlin. The longer
...
sentry-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`sentry`](https://crates.io/crates/sentry). Upstream Rust is the behavioral oracle while the
