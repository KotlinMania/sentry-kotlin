...
kotlin {
    ...
    val xcf = XCFramework("Sentry")

    macosArm64 {
        binaries.framework { baseName = "Sentry"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "Sentry"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "Sentry"
        flattenPackage = "io.github.kotlinmania.sentry"
    }

    android {
        namespace = "io.github.kotlinmania.sentry"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "sentry-kotlin", version.toString())

    pom {
        name.set("sentry-kotlin")
        description.set("Kotlin Multiplatform port of getsentry/sentry-rus - Sentry (sentry.io) client for Rust")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/sentry-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/sentry-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/sentry-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/sentry-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleSentryXCFramework",
    "assembleSentryDebugXCFramework",
    "assembleSentryReleaseXCFramework",
    "assembleDebugIosFatFrameworkForSentryXCFramework",
    "assembleReleaseIosFatFrameworkForSentryXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForSentryXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForSentryXCFramework",
    "assembleDebugMacosFatFrameworkForSentryXCFramework",
    "assembleReleaseMacosFatFrameworkForSentryXCFramework",
    "assembleDebugTvosFatFrameworkForSentryXCFramework",
    "assembleReleaseTvosFatFrameworkForSentryXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForSentryXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForSentryXCFramework",
    "assembleDebugWatchosFatFrameworkForSentryXCFramework",
    "assembleReleaseWatchosFatFrameworkForSentryXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForSentryXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForSentryXCFramework",
